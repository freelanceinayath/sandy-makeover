const FEATURES = [
  { icon: '💎', title: 'Luxury Products',      desc: 'Charlotte Tilbury, MAC, Huda Beauty — only premium cosmetics.' },
  { icon: '👑', title: 'Groom & Bride Certified', desc: 'Professional artistry for both brides and grooms.' },
  { icon: '✈️', title: 'Home & Venue Service',   desc: 'We travel to your location for ultimate comfort and ease.' },
  { icon: '🕐', title: '16-Hour Wear',           desc: 'Sweat-proof, camera-ready formulas that last all day.' },
]
