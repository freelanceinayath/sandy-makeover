      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 pb-16 border-b border-border">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="font-sans text-[13px] font-light text-cream/75 leading-[1.8] mb-8 max-w-[320px]">
          ...
          <div>
            ...
            {['Bridal Makeup','Groom Makeup','Hair Styling','Reception Styling','Engagement Styling'].map(s => (
              <a key={s} href="#services" className="block font-sans text-[12px] font-light text-cream/70 mb-3 hover:text-gold transition-colors duration-300">{s}</a>
            ))}
          </div>
          ...
          <div>
            ...
            <a href={IG} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 font-sans text-[12px] font-light text-cream/85 mb-6 hover:text-gold transition-colors">
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-sans text-[11px] font-light text-cream/60">
            © {year} Sandy Makeover. All rights reserved. •{' '}
            <a href="https://inayathbasha.vercel.app" target="_blank" rel="noopener noreferrer" className="hover:text-gold text-cream/70 hover:underline transition-colors duration-300">
