    ...
    <>
      <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${
        ...
        <div className="max-w-[1200px] mx-auto px-5 flex items-center justify-between">
          ...
          {/* Hamburger */}
          <button className="md:hidden flex flex-col gap-[5px] p-1" onClick={() => setMenuOpen(o => !o)} aria-label="Toggle menu">
      ...
      <div className={`fixed inset-0 z-[60] bg-dark flex flex-col items-center justify-center transition-transform duration-500 ${menuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <button className="absolute top-6 right-6 text-cream/50 hover:text-cream text-2xl" onClick={close}>✕</button>
